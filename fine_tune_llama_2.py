...
Original file is located at
    https://colab.research.google.com/drive/1M8-eGCj8KKIw-3wYgtpBT-7n1_m_pZlK
"""

!pip install bitsandbytes

!pip install -q accelerate==0.21.0 peft==0.4.0 transformers trl==0.4.7

!pip install bitsandbytes

import bitsandbytes as bnb
print("bitsandbytes running on CPU mode")
...
# Clear any possibly corrupted Hugging Face cache
!rm -rf /root/.cache/huggingface/datasets
!rm -rf /root/.cache/huggingface/hub

# Install latest compatible libraries (optional but recommended)
